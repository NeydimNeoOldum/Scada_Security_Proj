...
$first_names = ["Emre", "Mary", "John", "Emir", "Robert", "Jennifer", "Michael", "Linda", "William", "Utku", "David", "Barbara", "Richard", "Susan", "Joseph", "Jessica", "Thomas", "Sarah", "Charles", "Karen"];
$last_names = ["Amuk", "Johnson", "Williams", "Brown", "Jones", "Avci", "Miller", "Davis", "Ünlü", "Martinez", "Hernandez", "Lopez", "Gonzalez", "Wilson", "Anderson", "Thomas", "Taylor", "Moore", "Jackson", "Martin"];
